...
from .. import logger
from ..data import RadiateDataModule
...
default_cfg_sequential = OmegaConf.create(
    {
        "data": {
            "mask_radius": RadiateDataModule.default_cfg["max_init_error"],
            "prior_range_rotation": RadiateDataModule.default_cfg[
...
def run(
    ...
    **kwargs,
    ...
    dataset = RadiateDataModule(cfg.get("data", {}))
