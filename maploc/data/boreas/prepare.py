...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--data_dir", type=Path, default=Path(BoreasDataModule.default_cfg["data_dir"])
    )
    ...
    tiles_path = args.data_dir / BoreasDataModule.default_cfg["tiles_filename"]
    tiles_path = args.data_dir / "1114.pkl"
    if args.generate_tiles:
        ...
        osm_path = Path("/home/classlab2/root/OrienterNet/datasets/OSM/map8.osm")
